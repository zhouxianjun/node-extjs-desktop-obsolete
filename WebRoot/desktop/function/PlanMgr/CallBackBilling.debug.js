Ext.define(Gary.config.com + '.CallBackBilling', {  
    extend: 'Ext.panel.Panel',  
    title: '呼叫策略',
    closable : true,
    id: Gary.config.com + '.CallBackBilling',
    layout:'fit',
    initComponent: function() {
		...
		var addAction = Ext.create('Ext.Action', {
            ...
            handler: function() {
	        	Gary.doBilling(mask,1,grid,null,'addBilling');
            }
	    });
	    var modifyAction = Ext.create('Ext.Action', {
            ...
            handler: function() {
	        	...
	        	if(select[0]){
	        		Gary.doBilling(mask,1,grid,select[0],'modifyBilling');
	        	}
            },
            disabled: true
	    });
	    ...
	    eval(Gary.config.com + '.CallBackBilling' + '.superclass.initComponent.apply(this, arguments)');
    }
});